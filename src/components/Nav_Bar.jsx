...
export const Nav_Bar = () => {
    ...
    return(
    <div className="bg-white font-serif block flex justify-between p-4 shadow-lg">
		...
		<div className='justify-between flex justify-center items-center'>
			<Shopping_Cart />
			<button className='p-2 text-white bg-[#73BFFE] border-2 border-black rounded-2xl mr-2'>
				Iniciar Sesion
			</button>
			<button className='p-2 text-white bg-[#73BFFE] border-2 border-black rounded-2xl rounded-xl'>
				Registrate
			</button>
		</div>
    </div>
